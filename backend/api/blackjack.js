...
router.post('/init', async (request, response) => {
    try {
        ...
        // Blackjack ellenőrzés (21 az első 2 lapból)
        ...
        // Ellenőrizzük, hogy van-e elég egyenleg double/split-hez
