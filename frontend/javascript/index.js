document.addEventListener('DOMContentLoaded', function () {
    ...
    function beallitSimaGorgetest() {
        ...
        document.querySelectorAll('a[href^="#"]').forEach(function (link) {
            //csak azokat a linkeket veszi figyelembe, aminek a href attribútuma # karakterrel kezdődik, vagyis az oldal egy adott részére mutató linkeket. Ezáltal a sima görgetés csak az ilyen anchor linkekre lesz alkalmazva, és nem befolyásolja a többi link viselkedését.
            link.addEventListener('click', function () {
                if (osszecsukhato.classList.contains('show')) {
                    // Ez a feltétel ellenőrzi, hogy a navigációs menü jelenleg nyitva van-e (mobilnézetben), és ha igen, akkor bezárja azt.
